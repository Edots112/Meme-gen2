...
const CatMeme = () => {
    ...
    return (
        <div id='meme-gen' className='flex justify-center items-center h-screen '  >
            ...
            <h1 className="font-Priest 2xl:text-8xl xl:text-5xl lg:text-4xl  text-black font-bold text-center mb-5 mr-14   z-10">Make a SMILEO dog</h1>
            <h3 className="font-Priest 2xl:text-3xl xl:text-2xl  text-black font-bold text-center mb-5 mr-14 w-1/2 z-10">Scroll through the layers and customise your own SMILEO dog.</h3>
