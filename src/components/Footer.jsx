    ...
    return (
        <footer className="footer">
            <div className="social-links">
                <a href="https://x.com/Lionelinu_sol" target="_blank" rel="noopener noreferrer">
                    <FaTwitter size={48} />
                </a>
                <a href="https://t.me/LionelInu" target="_blank" rel="noopener noreferrer">
                    <FaTelegram size={48} />
                </a>
            ...
            <h1 className="font-Priest text-yellow-200 text-4xl md:text-6xl text-center">$LIONEL</h1>
