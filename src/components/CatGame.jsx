...
const CatGame = () => {
	...
	return (
		<div className="flex flex-col items-center p-10  bg-[#463221]" id="game">
			<h1 className="text-4xl font-bold mb-4 font-Adventure">Mascato Survival</h1>
			<p className="mb-4 text-2xl font-Mangat w-[50%]">
				Help <span className="text-yellow-500 font-bold">Mascato</span> survive all obstecals along his way
			</p>
			<canvas ref={canvasRef} width={1000} height={500} className="border border-orange-500 mb-4" onClick={handleCanvasClick} />
		</div>
	);
};
