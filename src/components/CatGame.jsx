            ...
            <div>
                <div className='flex justify-evenly w-screen text-center rounded-2xl items-top'>
                    <div className='relative flex flex-col justify-center items-center'>
                        ...
                        <h1 className="font-Dino 2xl:text-8xl xl:text-5xl lg:text-4xl text-white font-bold text-center mb-5 z-10">Make a OLLIY</h1>
                        <h3 className="font-Dino 2xl:text-3xl xl:text-2xl text-white font-bold text-center mb-5 w-1/2 z-10">Scroll through the options and customise your own OLLIY.</h3>
                        <h4 className="font-Dino 2xl:text-2xl xl:text-2xl text-white font-bold text-center mb-5 w-1/2 z-10">When you're happy with your own OLLIY, click Download and share your awesome creation</h4>
                    </div>
