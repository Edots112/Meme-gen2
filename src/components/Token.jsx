...
const Token = () => {
  return (
    <div id='token' className='bg-gradient-to-r from-purple-500 to-indigo-500 w-full text-white p-10 rounded-lg shadow-2xl h-auto'>
      <h1 className='font-Priest text-4xl md:text-6xl text-center mb-10 text-black'>Tokenomics</h1>
      <div className="flex flex-col md:flex-row justify-around items-stretch space-y-5 md:space-y-0 md:space-x-5">
        <motion.div
          className="flex-1 p-5 bg-black rounded-lg text-center shadow-lg"
          variants={pulseAnimation}
          initial="rest"
          whileHover="hover"
        >
          <span className='font-Priest text-2xl md:text-3xl block mb-2 text-white'>Supply</span>
          <p className='font-Priest text-xl md:text-2xl text-white'>1 Billion</p>
        </motion.div>
        <motion.div
          className="flex-1 p-5 bg-black rounded-lg text-center shadow-lg"
          variants={pulseAnimation}
          ...
          whileHover="hover"
        >
          <span className='font-Priest text-2xl md:text-3xl block mb-2 text-white'>Tax</span>
          <p className='font-Priest text-xl md:text-2xl text-white'>0% Buy/sell</p>
        </motion.div>
        <motion.div
          className="flex-1 p-5 bg-black rounded-lg text-center shadow-lg"
          variants={pulseAnimation}
          ...
          whileHover="hover"
        >
          <span className='font-Priest text-2xl md:text-3xl block mb-2 text-white'>Liquidity</span>
          <p className='font-Priest text-xl md:text-2xl text-white'>100% Burn</p>
        </motion.div>
      </div>
      <div className="flex flex-col items-center mt-10">
      </div>
      <h1 className='font-Priest text-4xl md:text-9xl text-center mb-10 text-black'>$GRIM</h1>
      <motion.div
