  ...
  return (
    <div id="buy" className=' py-20 px-4 mx-10 '>
      <div className="container mx-auto">
        <h1 className="text-7xl   p-6 font-bold text-center mb-16 font-Priest text-yellow-400">How to Buy <span className="text-blue-500">Max</span>?</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="bg-blue-900 p-8 shadow-lg rounded-xl text-white hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className='font-Priest text-center'>Load your wallet with $SOL. You'll need it to buy $Max tokens and participate in our community.</p>
          </motion.div>

          <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="bg-blue-900 p-8 shadow-lg rounded-xl text-white hover:shadow-2xl transition-shadow duration-300">
            <FaExchangeAlt className="text-5xl mx-auto mb-6 text-yellow-400" />
            <h2 className="text-2xl font-Priest font-bold mb-4 text-center">Swap for $Max</h2>
            <p className='font-Priest text-center'>Visit pump.fun to swap your $SOL for $Max tokens. Join the pack!</p>
          </motion.div>

          <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="bg-blue-900 p-8 shadow-lg rounded-xl text-white hover:shadow-2xl transition-shadow duration-300">
            <FaMagic className="text-5xl mx-auto mb-6 text-yellow-400" />
            <h2 className="text-2xl font-Priest font-bold mb-4 text-center">Create Your Max</h2>
            <p className='font-Priest text-center'>Use our Max meme generator to create your unique Max character. Let your creativity run wild!</p>
          </motion.div>
          ...
          <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="bg-blue-900 p-8 shadow-lg rounded-xl text-white hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className='font-Priest text-center'>Connect with fellow Max enthusiasts on our social media platforms. Stay updated and participate in events!</p>
          </motion.div>
          ...
          <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="bg-blue-900 p-8 shadow-lg rounded-xl text-white hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className='font-Priest text-center'>Show off your Max creation and enjoy being part of our vibrant community. Together, we'll make Max howl!</p>
          </motion.div>
        </div>
      </div>
    </div>
