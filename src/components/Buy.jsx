	...
	<div id="buy" className='buy'>
		...
		<div className="options">
			...
			<div className="option">
				...
				<p>Have SOL in your wallet to switch to $macho. If you don't have any SOL, you can buy SOL from an exchange.</p>
				<h4>Phantom wallet
				</h4>
			...
			<div className="option">
				...
				<h4>Mobile Users</h4>
				<p>Ready to join the movement? Head over to Raydium to easily purchase. Simply connect your wallet and swap for $MACHO to become part of the strongest community in crypto!</p>
